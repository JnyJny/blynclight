...
try:
    ...
    pkgs = pkgutil.iter_importer_modules.registry.keys()
    has_iter_modules = hasattr(zipimport.zipimporter, "iter_modules")
    zip_safe = has_iter_modules or zipimport.zipimporter in pkgs
