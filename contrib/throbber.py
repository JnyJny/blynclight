...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--red", action="store_true", default=False)
    parser.add_argument("-g", "--green", action="store_true", default=False)
    parser.add_argument("-b", "--blue", action="store_true", default=False)
